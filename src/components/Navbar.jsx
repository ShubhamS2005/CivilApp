    ...
    <nav className="bg-white text-gray-800 p-4 shadow-md">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="flex space-x-6 items-center">
          <Link to="/" className="flex justify-center items-center hover:bg-blue-100 px-5 py-2 rounded-md"> <Home height={15}/>  Home</Link>
          <Link to="/materials" className="hover:bg-blue-100 px-5 py-2 rounded-md"> Products</Link>
