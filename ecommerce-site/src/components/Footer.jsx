const Footer = () => {
  return (
    <footer className="bg-[#009688] text-gray-900 py-10 mt-10"> {/* Changed background and text color */}
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-6">
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-800">
            ...
            <li><a href="/materials" className="hover:text-gray-600">Materials</a></li> {/* ✅ Added */}
            <li><a href="/cart" className="hover:text-gray-600">Cart</a></li>
            <li><a href="/login" className="hover:text-gray-600">Login / Signup</a></li>
          </ul>
        </div>
      ...
      {/* Bottom Bar */}
      <div className="text-center mt-10 text-gray-700 border-t border-gray-400 pt-4 text-sm">
