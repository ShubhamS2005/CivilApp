      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 ">
            {[
              { title: "Material Supply", desc: "High-quality construction materials delivered to your site." },
              { title: "On-Site Delivery", desc: "Fast and reliable logistics for your orders." },
              { title: "Custom Orders", desc: "Tailored orders based on your specific project needs." },
              { title: "Architecture of House", desc: "Professional planning & design for residential projects." },
              { title: "Engineer", desc: "Expert engineering services to ensure safety and quality." },
              { title: "Contractor", desc: "Experienced contractors to manage your site efficiently." },
              { title: "Raj Mistri", desc: "Traditional craftsmanship with Raj Mistri experts." },
              { title: "Labour", desc: "Skilled labour available for all kinds of construction work." },
              { title: "Interior Designer", desc: "Creative interior solutions to beautify your living spaces." },
            ].map((service, i) => (
              <div
                key={i}
                className="bg-white p-6 shadow-md rounded-lg hover:scale-110 transition-all ease-in-out duration-200"
              >
  ...
  <div className="container mx-auto px-6">
    ...
    <div className="flex flex-col lg:flex-row gap-10 justify-center items-stretch">
      ...
      <div className="bg-white p-6 shadow-lg rounded-lg w-full lg:w-1/2 text-center transform transition-transform duration-300 hover:scale-105 hover:shadow-xl">
        ...
        <Link
          to="/labour"
          className="inline-block w-full px-6 py-3 bg-[#009688] text-white rounded-md hover:bg-blue-700 transition duration-300"
        >
          Book Labour
        </Link>
      </div>
