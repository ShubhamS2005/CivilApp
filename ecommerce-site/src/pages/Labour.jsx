...
const Labour = () => {
  ...
  const availableLocations = ["Delhi", "Mumbai", "Bangalore"];
      ...
      <div className="w-full max-w-xl bg-white p-8 rounded-lg shadow-lg mx-4">
        ...
        <div className="mb-6 flex flex-col sm:flex-row justify-center items-center gap-4">
          ...
          <button
            ...
            className="bg-[#009688] text-white px-4 py-2 rounded-md hover:bg-blue-700 transition"
          >
            Check Availability
          </button>
        </div>
        ...
        {isAvailable === null ? (
          ...
          <>
            ...
            <form onSubmit={handleBooking} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-[#009688] text-white py-3 rounded-md hover:bg-blue-700 transition duration-300"
              >
                Book Now
              </button>
